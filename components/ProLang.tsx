...
import { easeOutQuart, MySkill } from "@/lib/constants";
import { motion } from "framer-motion";
import { CSSProperties } from "react";

export default function ProLang({ mySkills, myLibSkills }: { mySkills: MySkill[]; myLibSkills: MySkill[] }) {
  return (
